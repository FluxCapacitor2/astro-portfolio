...
<YouTube
  title="Easysearch Demo"
  id="https://www.youtube.com/watch?v=mccURqQkOBo"
/>
...
<video
  loading="lazy"
  preload="none"
  data-src="/content/projects/easysearch/tree-animation.webm"
  autoplay
  controls
  loop
></video>
<video
  loading="lazy"
  preload="none"
  data-src="/content/projects/easysearch/hybrid-search-animation.webm"
  autoplay
  controls
  loop
></video>
